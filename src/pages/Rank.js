    ...
    return (
        <div className="flex h-screen w-screen justify-center items-center">
            <div className="mb-6 flex-col justify-center items-center lg:h-1/3 lg:w-1/5 w-1/2 h-1/4">
                ...
                {isLoading ? <div className='flex flex-row justify-center'><h1 className='text-gray-200 text-lg md:text-2xl'>Fetching Data...</h1></div> : <><form onSubmit={(e) => { e.preventDefault(); getRank(); }}>
